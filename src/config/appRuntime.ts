...
const EXPO_PUBLIC_ENV = Object.freeze({
  ...
  EXPO_PUBLIC_MONETIZATION_MONTHLY_PLAN_ENABLED:
    process.env.EXPO_PUBLIC_MONETIZATION_MONTHLY_PLAN_ENABLED,
  EXPO_PUBLIC_MONETIZATION_MONTHLY_PRICE_TRY:
    process.env.EXPO_PUBLIC_MONETIZATION_MONTHLY_PRICE_TRY,
  EXPO_PUBLIC_MONETIZATION_MONTHLY_PRODUCT_ID:
    process.env.EXPO_PUBLIC_MONETIZATION_MONTHLY_PRODUCT_ID,
